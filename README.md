...
1. [Overview](#overview)
2. [Project Description - What py-awsaudit does and why it is useful](#project-description)
3. [Setup - The basics of getting started with py-awsaudit](#setup)
    * [What py-awsaudit affects](#what-py-awsaudit-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with py-awsaudit](#beginning-with-py-awsaudit)
4. [Usage - Configuration options and additional functionality](#usage)
5. [Reference - An under-the-hood peek at what py-awsaudit is doing and how](#reference)
